...
> ⚠️ **นี่คือขั้นต่ำ (floor) ไม่ใช่เพดาน (ceiling)** — ถ้าคุณเป็นโมเดลความสามารถสูง (Opus-class, GPT-5+, etc.) และ repo มี Worthiness ≥ 70 → **ทำ Full Textbook ทันที** อย่า degrade ตัวเองลงมาที่ Standard เพียงเพราะตารางบอกว่า "ทำได้"
>
> ตารางนี้มีไว้เพื่อ: (1) ป้องกัน weaker model ทำเกินตัวจนพัง (2) ป้องกัน strong model เสียเวลากับงานที่ไม่ควรทำตำรา
...
2. ถ้า Worthiness ≥ 70 และคุณเป็น strong model → Full Textbook, ห้าม degrade
3. ถ้า Worthiness < 70 หรือคุณเป็น weaker model → ดูตาราง, ทำตามขั้นต่ำของ pass นั้น
4. สำคัญ: ทำเกินขั้นต่ำได้เสมอ — ถ้าทำได้ อย่าทำน้อย เพราะตาราง "อนุญาต"
5. ถ้าจะ promote → ต้องผ่าน Promotion Gate ก่อน
```
