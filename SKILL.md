...
> AI ไม่ต้องทำทุกอย่างพร้อมกัน — แต่ละ pass level ใช้ rules/layers/checks ต่างกัน

| Element | Quick Note | Standard Lesson | Full Textbook |
|---------|-----------|----------------|---------------|
| **Operating Rules** | 2, 3, 7, 11, 15 | +1, 4, 5, 8, 12, 14 | ครบ 15 ข้อ |
...
2. ดูตาราง → รู้ว่าต้องทำอะไร ไม่ต้องทำอะไร
3. ทำเฉพาะสิ่งที่ required ใน pass นี้ → reduce cognitive load
4. ถ้าจะ promote → ต้องผ่าน Promotion Gate ก่อน
```
